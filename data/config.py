config = {
    "8308": {
        "settings": [
            {"path": "axis0.requested_state",                             "value": 1},
            ...
            {"path": "axis0.config.motor.current_hard_max",             "value": 41},
    ...
    "5208": {
        "settings": [
            ...
            {"path": "config.dc_bus_overvoltage_trip_level",            "value": 50},
            {"path": "config.dc_bus_undervoltage_trip_level",           "value": 20},
            {"path": "config.dc_max_positive_current",                  "value": 1.2},
            {"path": "config.brake_resistor0.enable",                   "value": False},
            {"path": "config.brake_resistor0.resistance",               "value": 2},

            # Motor settings
            {"path": "axis0.config.motor.motor_type",                   "value": 2},
            {"path": "axis0.config.motor.phase_resistance",             "value": 13.6},
            {"path": "axis0.config.motor.pole_pairs",                   "value": 11},
            {"path": "axis0.config.motor.torque_constant",              "value": 0.345},
            {"path": "axis0.config.motor.current_hard_max",             "value": 1.5},
            {"path": "axis0.config.motor.current_soft_max",             "value": 1},
            {"path": "axis0.config.motor.calibration_current",          "value": 1},
